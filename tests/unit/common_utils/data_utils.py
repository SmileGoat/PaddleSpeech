...
#code is from:https://github.com/pytorch/audio/blob/main/test/torchaudio_unittest/common_utils/data_utils.py
...
#):
    ...
    #Args:
        ...
        #center: Pad the input sequence if True. See ``paddle.stft`` for the detail.
    ...
    #window = paddle.hann_window(win_length, device=waveform.device) if window is None else window
    #spec = paddle.stft(
        #waveform,
        #n_fft=n_fft,
